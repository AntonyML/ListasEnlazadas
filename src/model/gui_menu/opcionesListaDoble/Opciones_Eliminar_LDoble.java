...
public final class Opciones_Eliminar_LDoble extends javax.swing.JPanel {
     ...
     * @param l
     */
    public Opciones_Eliminar_LDoble(Menu menu, ListaDoble l) {
        logic = new Logic();
        this.menu = menu;
        initComponents();
        this.l = l;
    ...
    private void initComponents() {
        ...
        titu2.setText("Doble");
        add(titu2, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 120, 90, -1));

        titu1.setBackground(new java.awt.Color(0, 102, 102));
        titu1.setFont(new java.awt.Font("Dialog", 3, 24)); // NOI18N
        titu1.setText("Listas");
        add(titu1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 110, -1, -1));
