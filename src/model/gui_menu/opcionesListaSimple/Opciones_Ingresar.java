...
public final class Opciones_Ingresar extends javax.swing.JPanel {
     ...
     * @param l
     */
    public Opciones_Ingresar(Menu menu, ListaSimple l) {
        logic = new Logic();
        this.menu = menu;
        initComponents();
        this.l = l;
    ...
    public void editarTabla() {
        Object[][] data = logic.convertirMatrizMostrarAllDataListaSimple(l);
