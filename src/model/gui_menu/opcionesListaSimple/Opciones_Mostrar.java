 ...
 */
package model.gui_menu.opcionesListaSimple;
...
public final class Opciones_Mostrar extends javax.swing.JPanel {

    private final Logic logic;
    private final Menu menu;
    private final ListaSimple l;
     ...
     * @param l
     */
    public Opciones_Mostrar(Menu menu, ListaSimple l) {
        logic = new Logic();
        this.menu = menu;
        initComponents();
        this.l = l;
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        if (!jTextCodigo.getText().isEmpty() && jTextField1.getText().isEmpty()
            ...
            editarTabla(logic.MostrarIdAndNameLSimple(l, 2));
        ...
        if (jTextCodigo.getText().isEmpty() && !jTextField1.getText().isEmpty()
                && jTextField2.getText().isEmpty() && jTextField3.getText().isEmpty()
                && jCheckBox2.isSelected()) {
            editarTabla(logic.MostrarIdAndNameLSimple(l, 3));
        ...
        if (!jTextCodigo.getText().isEmpty() && jTextField1.getText().isEmpty()
                && jTextField2.getText().isEmpty() && jTextField3.getText().isEmpty()
                && !jCheckBox2.isSelected()) {
            editarTabla(logic.buscarporID_LSimple(l, Integer.parseInt(jTextCodigo.getText())));
        ...
        if (jTextCodigo.getText().isEmpty() && !jTextField1.getText().isEmpty()
                && jTextField2.getText().isEmpty() && jTextField3.getText().isEmpty()
                && !jCheckBox2.isSelected()) {
            editarTabla(logic.buscarPorNombreLSimple(l,jTextField1.getText()));
        ...
        if (jTextCodigo.getText().isEmpty() && jTextField1.getText().isEmpty()
            ...
            editarTabla(logic.buscarporPosicionLSimple(l, Integer.parseInt(jTextField4.getText())));
