...
public final class Opciones_Modificar extends javax.swing.JPanel {
     ...
     * @param l
     */
    public Opciones_Modificar(Menu menu, ListaSimple l) {
        logic = new Logic();
        this.menu = menu;
        initComponents();
        this.l = l;
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        if (jTextCodigo.getText().isEmpty() || jTextField1.getText().isEmpty() || jTextField2.getText().isEmpty() || jTextField3.getText().isEmpty()) {
            ...
            //////editamos la tabla
            editarTabla(logic.modificarPorIdLSimple(l, Integer.parseInt(jTextCodigo.getText()), e));
