...
public final class Opciones_Total_LCola extends javax.swing.JPanel {
     ...
     * @param c
     */
    public Opciones_Total_LCola(Menu menu, Cola c) {
        logic = new Logic();
        this.menu = menu;
        initComponents();
        this.c = c;
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        jLabel4.setText(String.valueOf(c.getTamano()));
