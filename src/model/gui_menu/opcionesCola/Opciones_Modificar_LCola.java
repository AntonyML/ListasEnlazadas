...
public final class Opciones_Modificar_LCola extends javax.swing.JPanel {
     ...
     * @param c
     */
    public Opciones_Modificar_LCola(Menu menu, Cola c) {
        logic = new Logic();
        this.menu = menu;
        initComponents();
        this.c = c;
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        if (jTextCodigo.getText().isEmpty() || jTextField1.getText().isEmpty() || jTextField2.getText().isEmpty() || jTextField3.getText().isEmpty()) {
            ...
            //////editamos la tabla
            editarTabla(logic.modificarPorIdCola(c, Integer.parseInt(jTextCodigo.getText()), e));
