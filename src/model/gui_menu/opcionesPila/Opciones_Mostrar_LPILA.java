...
public final class Opciones_Mostrar_LPILA extends javax.swing.JPanel {
     ...
     * @param p
     */
    public Opciones_Mostrar_LPILA(Menu menu, Pila p) {
        logic = new Logic();
        this.menu = menu;
        initComponents();
        this.p = p;
    ...
    private void initComponents() {
        ...
        titu2.setText("Pila");
        add(titu2, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 20, 50, -1));
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        if (!jTextCodigo.getText().isEmpty() && jTextField1.getText().isEmpty()
            ...
            editarTabla(logic.MostrarIdAndNamePila(p, 2));

            //////////////////
            //falta agregar el numero de estudiantes
            menu.getjLabel4().setText("Estudiantes registrados :" + p.getTamano());
        ...
        if (jTextCodigo.getText().isEmpty() && !jTextField1.getText().isEmpty()
                && jTextField2.getText().isEmpty() && jTextField3.getText().isEmpty()
                && jCheckBox2.isSelected()) {
            editarTabla(logic.MostrarIdAndNamePila(p, 3));
        ...
        if (!jTextCodigo.getText().isEmpty() && jTextField1.getText().isEmpty()
                && jTextField2.getText().isEmpty() && jTextField3.getText().isEmpty()
                && !jCheckBox2.isSelected()) {
            editarTabla(logic.buscarporID_Pila(p, Integer.parseInt(jTextCodigo.getText())));
        ...
        if (jTextCodigo.getText().isEmpty() && !jTextField1.getText().isEmpty()
                && jTextField2.getText().isEmpty() && jTextField3.getText().isEmpty()
                && !jCheckBox2.isSelected()) {
            editarTabla(logic.buscarPorNombrePila(p,jTextField1.getText()));
        ...
        if (jTextCodigo.getText().isEmpty() && jTextField1.getText().isEmpty()
            ...
            editarTabla(logic.buscarporPosicionPila(p, Integer.parseInt(jTextField4.getText())));
