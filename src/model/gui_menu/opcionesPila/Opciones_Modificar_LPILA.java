...
public final class Opciones_Modificar_LPILA extends javax.swing.JPanel {
     ...
     * @param p
     */
    public Opciones_Modificar_LPILA(Menu menu, Pila p) {
        logic = new Logic();
        this.menu = menu;
        initComponents();
        this.p = p;
    ...
    private void initComponents() {
        ...
        titu2.setText("Pila");
        add(titu2, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 40, 50, -1));
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        if (jTextCodigo.getText().isEmpty() || jTextField1.getText().isEmpty() || jTextField2.getText().isEmpty() || jTextField3.getText().isEmpty()) {
            ...
            //////editamos la tabla
            editarTabla(logic.modificarPorIdPila(p, Integer.parseInt(jTextCodigo.getText()), e));
