...
public final class Opciones_Eliminar_LPILA extends javax.swing.JPanel {
     ...
     * @param p
     */
    public Opciones_Eliminar_LPILA(Menu menu, Pila p) {
        logic = new Logic();
        this.menu = menu;
        initComponents();
        this.p = p;
    ...
    public void editarTabla() {
        Object[][] data = logic.convertirMatrizMostrarAllDataPila(p);
        table.setModel(new javax.swing.table.DefaultTableModel(
                data, eti
        ));
        jScrollPane1.setViewportView(table);
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        if (!p.isEmpty()) {
            JOptionPane.showMessageDialog(null, "Se elimino: " + p.pop().getE().toString());
            p.setAux(null);
            editarTabla();
        } else {
