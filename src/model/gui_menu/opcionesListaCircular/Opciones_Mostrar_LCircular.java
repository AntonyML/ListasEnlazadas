...
public final class Opciones_Mostrar_LCircular extends javax.swing.JPanel {

    private final Logic logic;
    private final Menu menu;
    private final ListaCircular l;
     ...
     * @param l
     */
    public Opciones_Mostrar_LCircular(Menu menu, ListaCircular l) {
        logic = new Logic();
        this.menu = menu;
        initComponents();
        this.l = l;
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        if (!jTextCodigo.getText().isEmpty() && jTextField1.getText().isEmpty()
            ...
            editarTabla(logic.MostrarIdAndNameLCircular(l, 2));
        ...
        if (jTextCodigo.getText().isEmpty() && !jTextField1.getText().isEmpty()
                && jTextField2.getText().isEmpty() && jTextField3.getText().isEmpty()
                && jCheckBox2.isSelected()) {
            editarTabla(logic.MostrarIdAndNameLCircular(l, 3));
        ...
        if (!jTextCodigo.getText().isEmpty() && jTextField1.getText().isEmpty()
                && jTextField2.getText().isEmpty() && jTextField3.getText().isEmpty()
                && !jCheckBox2.isSelected()) {
            editarTabla(logic.buscarporID_LCircular(l, Integer.parseInt(jTextCodigo.getText())));
        ...
        if (jTextCodigo.getText().isEmpty() && !jTextField1.getText().isEmpty()
                && jTextField2.getText().isEmpty() && jTextField3.getText().isEmpty()
                && !jCheckBox2.isSelected()) {
            editarTabla(logic.buscarPorNombreLCircular(l,jTextField1.getText()));
        ...
        if (jTextCodigo.getText().isEmpty() && jTextField1.getText().isEmpty()
            ...
            editarTabla(logic.buscarporPosicionLCircular(l, Integer.parseInt(jTextField4.getText())));
