...
public final class Opciones_Ingresar_LCircular extends javax.swing.JPanel {
     ...
     * @param l
     */
    public Opciones_Ingresar_LCircular(Menu menu, ListaCircular l) {
        logic = new Logic();
        this.menu = menu;
        initComponents();
        this.l = l;
    ...
    public void editarTabla() {
        Object[][] data = logic.convertirMatrizMostrarAllDataLCircular(l);
